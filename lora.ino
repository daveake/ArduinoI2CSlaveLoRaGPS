...
void SetParametersFromLoRaMode(int LoRaMode)
{
  ...
  Serial.print("LoRa Mode = "); Serial.println(LoRaMode);
...
void CheckLoRa()
{
  if (digitalRead(dio0))
  {
    ...
    {   
      ...
      Serial.println((char *)Message);  // Telemetry='$$LORA1,108,20:30:39,51.95027,-2.54445,00141,0,0,11*9B74

      if (Message[0] == '$')
      {
        Serial.print("Message=");
        Serial.println((char *)Message);
        strcpy(LoRa, (char *)Message);
        LoRaActive = 1;
      }
      else if (Message[0] == '%')
      {
